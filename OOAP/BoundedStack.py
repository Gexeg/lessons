'''
Правильно я понимаю, что если в задании указано, что нужно составить АТД и реализовать его, то проверка задачи происходит
в 2 этапа: сначала проверяется АТД, а затем, после его согласования, реализация?
